...
const pb_field_t SensorBugUplinkMsg_fields[18] = {
    ...
    PB_FIELD(100, UENUM   , OPTIONAL, STATIC  , OTHER, SensorBugUplinkMsg, reset_source, mic_en, 0),
    PB_FIELD(128, UINT32  , OPTIONAL, STATIC  , OTHER, SensorBugUplinkMsg, sw_version_major, reset_source, 0),
